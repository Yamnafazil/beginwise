...
class KgQuizscreen extends StatefulWidget {
  const KgQuizscreen({Key? key}) : super(key: key);

  @override
  _KgquizscreenState createState() => _KgquizscreenState();
}

class _KgquizscreenState extends State<KgQuizscreen> {
  ...
  Future<void> _fetchQuizData() async {
    var url = Uri.parse('http://192.168.1.109:5000/api/quiz/all/grade/2');
    try {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Kindergarten Quiz',
          style: TextStyle(
            fontSize: 25,
