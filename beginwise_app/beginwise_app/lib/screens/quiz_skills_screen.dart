...
class QuizSkillsScreen extends StatefulWidget {
  const QuizSkillsScreen({Key? key}) : super(key: key);

  @override
  _QuizSkillsScreenState createState() => _QuizSkillsScreenState();
}

class _QuizSkillsScreenState extends State<QuizSkillsScreen> {
  ...
  Future<void> _fetchQuizData() async {
    var url = Uri.parse('http://192.168.1.109:5000/api/quiz/all/grade/1');
    try {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Playgroup Quiz',
          style: TextStyle(
            fontSize: 25,
